package com.yeebee.invest.views;
...
public class TopBar extends RelativeLayout {
	...
	public TopBar(Context context, AttributeSet attrs) {
		...
		// mTitleView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,mTitleTextSize);
		if (mTitleTextSize > 21) {
			mTitleTextSize = 21;
		}
		mTitleView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, mTitleTextSize);
		Log.v("mTitleTextSize", mTitleTextSize + "");
	...
	// 设置右侧文字
	public void setRigheText(String text) {
		mRightButton.setText(text);
	}

	// 设置右侧文字大小
	public void setRigheTextSize(int size) {
		mRightButton.setTextSize(size);
	}

	// 设置右侧文字颜色
	public void setRigheTextColor(int color) {
		mRightButton.setTextColor(color);
	}

	// 设置右侧背景
	public void setRightBackground(Drawable drawable) {
		mRightButton.setBackgroundDrawable(drawable);
	}
