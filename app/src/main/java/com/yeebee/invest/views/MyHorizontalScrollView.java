...
import com.yeebee.invest.adapter.baseAdapter.BaseHorizontalScrollViewAdapter;
		...
		OnClickListener
{
	 ...
	 * 子元素的宽度
	 */
	private int mChildWidth ,mChildWidth2;
	/**
	 * 子元素的高度
	 */
...
//			mContainer = (LinearLayout) getChildAt(0);
	 ...
	 * @param mAdapter
	 */
	public void initDatas(BaseHorizontalScrollViewAdapter mAdapter)
	{
